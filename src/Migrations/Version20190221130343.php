 ...
 */
final class Version20190221130343 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE all_match_league CHANGE event_date event_date DATE NOT NULL');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE all_match_league CHANGE event_date event_date VARCHAR(255) DEFAULT NULL COLLATE utf8mb4_unicode_ci');
